(function ($) {
	...
	$(".blog-grid .directory-item").hide();
		$(".blog-grid .directory-item").slice(0, 10).show();
		$("#blog-load-more").on('click', function (e) {
		e.preventDefault();
		$(".blog-grid .directory-item:hidden").slice(0, 10).slideDown();
		if ($(".blog-grid .directory-item:hidden").length == 0) {
