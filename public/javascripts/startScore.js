function scoreFun(object, opts) {
    var defaults = {
        fen_d: 16,
        ScoreGrade: 10,
        types: ["Eek! Methinks not", "Eek! Methinks not", "Meh. I've experienced better.", "Meh. I've experienced better.", "A-OK.", "A-OK.", "Yay! I'm a fan.", "Yay! I'm a fan.", "Woohoo! As good as it gets!", "Woohoo! As good as it gets!"],
        nameScore: "fenshu",
        parent: "star_score",
        attitude: "attitude"
    };
